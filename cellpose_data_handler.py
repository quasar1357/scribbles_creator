...
def create_cellpose_scribble(folder_path, img_num, bin=0.1, margin=0.75, rel_scribble_len=False, scribble_width=1, mode="all", class_dist="relative", enforce_max_perc=False, save_res=False, suff=False, show_res=False, show_img=True, print_steps=False):
    '''
